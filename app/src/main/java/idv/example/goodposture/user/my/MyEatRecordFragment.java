...
public class MyEatRecordFragment extends Fragment {
    ...
    private LineChart eatChart;
    private TextView tvEatCalorie;
    ...
    private void findViews(View view) {
        eatChart = view.findViewById(R.id.eatChart);
        tvEatCalorie = view.findViewById(R.id.tv_eatCalorie);
        ...
        db.collection("record")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        tvEatCalorie.append(" " + (int) total + " 大卡");
                    } else {
    ...
    private void handleChart() {
        ...
        // 設定 Y 軸
        YAxis rightAxis = eatChart.getAxisRight();
        rightAxis.setEnabled(false);

        // 設定圖表描述
        Description description = new Description();
        description.setText("");
        eatChart.setDescription(description);

        LineData lineData = new LineData(lineDataSet);
        eatChart.setData(lineData);
        // 更新圖表
        eatChart.invalidate();
    }
